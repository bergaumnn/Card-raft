        ...
        <div className="h-full flex flex-col justify-center px-12 space-y-5">
          {data.phone && (
            <div className="flex items-center space-x-4">
              ...
              <span className="text-base text-gray-700">{data.phone}</span>
            </div>
          )}
          {data.email && (
            <div className="flex items-center space-x-4">
              ...
              <span className="text-base text-gray-700 break-all">{data.email}</span>
            </div>
          )}
          {data.website && (
            <div className="flex items-center space-x-4">
              ...
              <span className="text-base text-gray-700">{data.website}</span>
            </div>
          )}
          {data.address && (
            <div className="flex items-center space-x-4">
              ...
              <span className="text-base text-gray-700">{data.address}</span>
            </div>
          )}
        </div>
      </div>
